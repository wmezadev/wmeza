    ...
    <Layout location={location} title={siteTitle}>
      ...
      <div style={{ maxWidth: '900px', margin: 'auto', padding: '40px 20px' }}>
        ...
        <p>
          <ul>
            <li>
              <strong>1993:</strong> I was born in Venezuela on November 14th. With 5 brothers
              before and 3 after.
            </li>
            <li>
            ...
            <li>
              <strong>2015:</strong> I began my service as a missionary in the church of Jesus
